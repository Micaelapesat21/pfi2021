...
class FormularioMensajeRespuesta extends Component {
    ...
    enviar() {
        ...
        console.log("mensaje" + JSON.stringify(this.props.mensaje))
        ...
        if (
           ...
           var dict = this.getNotificacionModel();
           console.log("Respuesta modelo: " + dict);
           this.postRespuestaMensaje(dict);
    ...
    postRespuestaMensaje = (cursoMensajeInfo) => {
        this.setState({ loading: true });
        console.log("CURSO Respuesta:" + cursoMensajeInfo);
        console.log("MENSAJE id: " + this.props.mensaje.id);
        MensajesAPI.crearNotificacion(cursoMensajeInfo, this.handlePostCursoMensaje.bind(this));
        console.log("mensaje" + JSON.stringify(this.props.mensaje))
        MensajesAPI.actualizarMensaje(this.props.mensaje.id, this.handlePostCursoMensaje.bind(this));
    }

    handlePostCursoMensaje = async (cursoMensajeInfo) => {
        this.setState({ loading: false });
        console.log("handlePostCursoMensaje en formulario respuesta" + JSON.stringify(cursoMensajeInfo));
    ...
    getNotificacionModel() {
        return {            
            usuario: this.props.mensaje.usuario,
    ...
    closeSuccessModal() {
        ...
        this.props.cursoMensaje(this.props.mensaje);
    ...
    render() {
        ...
        return (
            <Grid >
                ...
                <ErrorMessageModal title={'Respuesta enviada con éxito'} errorMessage= { this.getSuccessMessage() } isOpen={this.state.successMessageIsOpen} closeErrorModal={this.closeSuccessModal.bind(this)} />
                    ...
                    <Grid container spacing={3}>    
                        ...
                        <Grid item xs={20} sm={16}>
                           */} 
                            ...
                            fullWidth
                            rows={4}
                            defaultValue="Escriba respuesta..."
                            variant="outlined"
...
FormularioMensajeRespuesta.propTypes = {
    classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(FormularioMensajeRespuesta);
