...
class FormularioDatosRetiros extends Component {
    ...
    componentDidMount() {
        console.log("Formulario datos retiros: " + this.state.alumno);
        //  this.get()
    }
            ...
            <Grid >
                ...
                <Paper className={classes.paper}>
                    <div className="container">
                        <div className="row"> 
                            {
                                this.state.retiros.map( objectcurso => (
...
FormularioDatosRetiros.propTypes = {
    classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(FormularioDatosRetiros);
