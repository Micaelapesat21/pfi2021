...
class FormularioDatosAlumnos2 extends Component {
                ...
                <Paper className={classes.paper}>
                    ...
                    <Grid item xs={12} sm={6}>
                            <TextField
                                required
                                id="NombreTitular"
                                name="titularSeleccionado"
                                label="Nombre del Titular"
                                fullWidth
                                autoComplete="Nombre"
                                value={this.props.alumnoActualizar.nombreTitular}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                autoComplete="Nombre"
                                value={this.props.alumnoActualizar.nombre}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                value={this.props.alumnoActualizar.apellido}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                autoComplete="Correo"
                                value={this.props.alumnoActualizar.correo}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                autoComplete="Dni"
                                value={this.props.alumnoActualizar.dni}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                autoComplete="País"
                                value={this.props.alumnoActualizar.pais}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                value={this.props.alumnoActualizar.provincia}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                fullWidth
                                autoComplete="Ciudad"
                                value={this.props.alumnoActualizar.ciudad}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                value={this.props.alumnoActualizar.codigoPostal}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}> 
                            <TextField
                                ...
                                value={this.props.alumnoActualizar.direccion}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                value={this.props.alumnoActualizar.telefono1}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                value={this.props.alumnoActualizar.telefono2}
                                onChange={this.handleChange}
                                InputProps={{
                                    readOnly: this.state.redOnly,
                                }}
...
FormularioDatosAlumnos2.propTypes = {
    classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(FormularioDatosAlumnos2);
