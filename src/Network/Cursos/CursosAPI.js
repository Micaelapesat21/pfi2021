...
class CursosAPI extends Component {
    ...
    createCurso(cursoInfo, handlePostCursoInfo) {
     ...
     // let url = "http://172.20.10.8:8080/regiapppfi2021/crearCurso/Esccurso";
    ...
    getCursos(handleGetCursos)
    {
        ...
        //let url =  "http://172.20.10.8:8080/regiapppfi2021/obtenerCursos";
    ...
    getAlumnosPorCursos(curso,handleGetAlumnosPorCursos)
    {
        ...
        //let url =  "http://172.20.10.8:8080/regiapppfi2021/obtenerAlumnosPorCursos/" + curso;
    ...
    getCursoPorId(idcurso,handleGetCursoPorId)
    {
       ...
       // let url =  "https://regiapppfi2021.herokuapp.com/regiapppfi2021/obtenerCursosPorId/" + idcurso;
        ...
        //let url =  "http://172.20.10.8:8080/regiapppfi2021/obtenerCursosPorId/" + idcurso;
    ...
    crearNotificacion(notificacionInfo, handlePostCursoInfo) {
      ...
      //let url = "http://172.20.10.8:8080/regiapppfi2021/crearNotificacionMasiva/Escnotificacion";
